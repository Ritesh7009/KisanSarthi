...
export const translations = {
  en: {
    appTitle: 'KisanSarthi India',
    appSubtitle: 'National Smart Mandi Procurement & Queue Management System',
    govtTag: 'Ministry of Agriculture & Farmers Welfare • National Agriculture Market (e-NAM)',
    tagline: 'Zero Wait Mandi Slots • Guaranteed MSP • Instant DBT Direct to Bank',
    
    // Auth & Roles
    loginAsFarmer: 'Farmer Login (Kisan Portal)',
    loginAsAdmin: 'Officer Login (APMC / Mandi Secretary)',
    loginDescription: 'Secure OTP-based authentication for farmers and mandi officers across India',
    mobileNumber: 'Mobile Number / Aadhaar / Kisan ID',
    ...
    asFarmer: 'Login as Farmer (Pan-India Demo)',
    asAdmin: 'Login as Mandi Officer (APMC Mandi)',
    logout: 'Logout',
  ...
  hi: {
    appTitle: 'किसान सारथी भारत',
    appSubtitle: 'स्मार्ट राष्ट्रीय कृषि उपज मंडी उपार्जन एवं लाइव टोकन कतार प्रणाली (e-NAM)',
    govtTag: 'कृषि एवं किसान कल्याण मंत्रालय, भारत सरकार • राष्ट्रीय कृषि बाजार (e-NAM)',
    tagline: 'शून्य प्रतीक्षा स्लॉट • पारदर्शी राष्ट्रीय एमएसपी • त्वरित प्रत्यक्ष बैंक अंतरण (DBT)',

    // Auth & Roles
    loginAsFarmer: 'किसान लॉगिन (Kisan Portal)',
    loginAsAdmin: 'अधिकारी लॉगिन (मंडी सचिव / उपार्जन केंद्र)',
    loginDescription: 'ओटीपी आधारित सुरक्षित प्रमाणीकरण - देश भर के किसानों व मंडी अधिकारियों के लिए',
    mobileNumber: 'मोबाइल नंबर / आधार / किसान आईडी',
    ...
    asFarmer: 'किसान के रूप में लॉगिन करें (अखिल भारतीय डेमो)',
    asAdmin: 'मंडी अधिकारी के रूप में लॉगिन करें (एपीएमसी मंडी)',
    logout: 'लॉगआउट',
  ...
  mal: {
    appTitle: 'किसान सारथी (अखिल भारत)',
    appSubtitle: 'मंडी उपार्जन अर ऑनलाइन टोकन व्यवस्था (e-NAM)',
    govtTag: 'भारत सरकार अर राज्य मंडी बोर्ड • राष्ट्रीय ई-नाम मंडी',
    ...
    asFarmer: 'किसान भाई (ऑल इंडिया डेमो)',
    asAdmin: 'मंडी सचिव (मंडी केंद्र)',
    logout: 'बार निकलो',
    loggedInAs: 'लॉगिन है',
    ...
    tabAdminReports: 'अखिल भारतीय रिपोर्ट',

    // Booking & Queue
    selectState: 'आपणो राज्य चुणो',
    selectDistrict: 'आपणो जिलो चुणो',
    selectMandi: 'मंडी केंद्र चुणो (APMC / e-NAM)',
