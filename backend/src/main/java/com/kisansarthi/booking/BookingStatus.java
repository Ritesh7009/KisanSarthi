...
public enum BookingStatus {
    ...
    private static final Map<BookingStatus, Set<BookingStatus>> VALID_TRANSITIONS = Map.ofEntries(
            ...
            Map.entry(WEIGHING, EnumSet.of(WEIGHMENT_STAGE_1, QUALITY_CHECK, WEIGHMENT_COMPLETED, REJECTED)),
            Map.entry(WEIGHMENT_STAGE_1, EnumSet.of(QUALITY_CHECK, WEIGHMENT_STAGE_2, WEIGHMENT_COMPLETED, REJECTED)),
            ...
            Map.entry(PROCUREMENT_COMPLETED, EnumSet.of(PAYMENT_PENDING, PAYMENT_INITIATED, PAYMENT_PROCESSING)),
            Map.entry(PAYMENT_PENDING, EnumSet.of(PAYMENT_INITIATED, PAYMENT_PROCESSING)),
            Map.entry(PAYMENT_INITIATED, EnumSet.of(PAYMENT_PROCESSING, PAYMENT_CREDITED, COMPLETED)),
